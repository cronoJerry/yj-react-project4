...
const GNB = [
    ...
    { mainTitle: "공간대관안내", subTitle: "Rental", link: "/rental" },
        ...
        <div className="w-full flex justify-center h-header-height shadow-md">
            ...
            <div className="w-full flex justify-center px-layout-padding ">
                <div className="w-full flex justify-center relative ">
                    ...
                    {/* LNB */}
                    <div className="flex space-x-8 py-2 absolute right-0 top-0 items-center uppercase text-sm ">
                        <div>
                            <SearchAsset />
                        </div>
                        <div>Home</div>
                        ...
                        <select
                            size="sm"
                            className="border-neutral-300  text-sm rounded-sm py-1"
                        >
                            <option>한국어</option>
